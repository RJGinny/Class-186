...
firebase = firebase.FirebaseApplication("https://python-186-default-rtdb.firebaseio.com/", None)
...
def enterRoom(): 
    ...
    btn_send = Button(message_window, text="Send", font = 'arial 13', bg="#D6CA98", fg="black",command=sendData, padx=10, relief=FLAT)
